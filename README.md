...
This project uses third-party AI APIs (such as the Groq API).

Responses are generated by external AI models and may be incorrect, biased, incomplete, or outdated. Do not rely on outputs for medical, legal, financial, or safety-critical decisions.

Users must provide their own API keys.

API keys are stored locally in the browser and are not collected, stored, or transmitted by this project.

Never share your API key publicly.

This tool may use external AI services that charge based on usage.

You are fully responsible for any costs associated with your API provider account.
...
This application is a lightweight user interface wrapper for the official Groq API.

This project does not encourage, support, or assist with bypassing platform security or safety measures.
